...
import { getBentukKegiatanById, putBentukKegiatan } from "../../functions/BentukKegiatan";
...
export default function EditBentukKegiatan(params){
    ...
    useEffect(() => {
        async function getData() {
          const dataBentukKegiatan = await getBentukKegiatanById(params.match.params.id);
