      ...
      <>
        ...
        >
          ...
          <Switch>
            ...
            <Route path="/app/editProgramStudi/:id" component={EditProgramStudi}/>

            <Route path="/app/jenispartner" component={JenisPartner} />
            <Route path="/app/tambahJenisPartner" component={TambahJenisPartner} />
            <Route path="/app/editJenisPartner/:id" component={EditJenisPartner} />

            <Route path="/app/jenisdokumen" component={JenisDokumen} />
            <Route path="/app/tambahJenisDokumen" component={TambahJenisDokumen} />
            <Route path="/app/editJenisDokumen/:id" component={EditJenisDokumen} />

            <Route path="/app/bentukkegiatan" component={BentukKegiatan} />
            <Route path="/app/tambahBentukKegiatan" component={TambahBentukKegiatan} />
            <Route path="/app/editBentukKegiatan/:id" component={EditBentukKegiatan} />
